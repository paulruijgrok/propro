#!/usr/bin/env python3
"""Sequence overview PDF — a one-page bench report for a protein sequence.
...
From the command line::
    ...
    python "bench tools/reports/sequence_overview_pdf.py" --sequence MKT... --id my_protein
    python "bench tools/reports/sequence_overview_pdf.py" --fasta sequences.fasta --outdir reports/
...
# back to adding the repo root (two levels up from this file) to sys.path.
try:
...
def generate_sequence_overview_pdf(
    ...
    fig.text(
        0.02, 0.01,
        f"Generated by propro (bench tools/reports/sequence_overview_pdf.py) — "
